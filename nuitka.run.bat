...
python -m nuitka --follow-imports --follow-stdlib --onefile --show-scons --show-progress --show-modules --disable-console --assume-yes-for-downloads --force-stdout-spec=dude.stdout.log --force-stderr-spec=dude.stderr.log --windows-icon-from-ico=./icon.ico --include-data-files=./icon.png=./icon.png --include-data-files=./LICENSE=./LICENSE --enable-plugin=tk-inter --remove-output --output-filename=dudegui.exe --lto=yes ./dude.py
